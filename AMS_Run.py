...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="seashell2", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='/usr/local/mysql/bin/mysql', user='root', password='root1234', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            ENR = tk.Label(MFW, text="Enter Roll no", width=15, height=2, fg="black", bg="white",
                           font=('times', 15, ' bold '))
            ...
            def attf():
                directory_path = "Attendance/Manually Attendance/-------Check atttendance-------"
                if os.name == 'posix':  # macOS
                    subprocess.Popen(['open', '-R', directory_path])
                elif os.name == 'nt':  # Windows
                    subprocess.Popen(['explorer', '/select,', os.path.normpath(directory_path)])

            MFW = tk.Tk()
            attf_button = tk.Button(MFW, text="Check Sheets", command=attf, fg="black", bg="white", width=12,
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            Notification.configure(text=res, bg="seashell2", width=50, font=('times', 18, 'bold'))
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(text=e, bg="seashell2", fg="black", width=33, font=('times', 15, 'bold'))
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='usr/local/mysql/bin/mysql', user='root', password='root1234', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                Notifica.configure(text=M, bg="seashell2", fg="black", width=33, font=('times', 15, 'bold'))
                Notifica.place(x=20, y=250)
                ...
                root.configure(background='snow')
                cs = "/Users/vishalreddy/Downloads/RTPR2" + fileName
    ...
    def Attf():
        folder_path = "Attendance/Manually Attendance"  # Replace with your actual folder path
        file_name = "-------Check atttendance-------"  # Replace with your actual file or folder name
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white",command=Fillattendances, bg="black", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'Vishal' :
            ...
            valid ='Incorrect ID or Password'
            Nt.configure(text=valid, bg="white", fg="red", width=38, font=('times', 19, 'bold'))
            Nt.place(x=120, y=350)


    Nt = tk.Label(win, text="Attendance filled Successfully", bg="seashell2", fg="black", width=40,
                  height=2, font=('times', 19, 'bold'))
    # Nt.place(x=120, y=350)
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="grey", fg="black", width=50,
...
txt = tk.Entry(window, validate="key", width=20, bg="white", fg="blue", font=('times', 25, ' bold '))
...
txt2 = tk.Entry(window, width=20, bg="white", fg="blue", font=('times', 25, ' bold '))
...
AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="white"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendace",fg="black",command=subjectchoose  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
