...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='root1234', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Button(errsc2, text='OK', command=del_errsc2, fg="black", bg="seashell2", width=9, height=1,
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            Notification.configure(text=res, bg="seashell2",fg="Black", width=50, font=('times', 18, 'bold'))
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost ', user='root', password='root1234', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(root, width=8, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="seashell2", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
                root.mainloop()
...
message = tk.Label(window, text="Attendance Management System", bg="skyblue1", fg="black", width=50,
